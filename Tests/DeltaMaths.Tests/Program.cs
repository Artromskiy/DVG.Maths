    ...
    internal static class Program
    {
        private static int Main()
        {
            var tests = new (string Name, Action Run)[]
            {
                ...
                ("floating-point shader operations preserve GLSL bit semantics", VectorBehaviorTests.FloatingPointShaderOperations),
                ("relational and select shader helpers are component-wise", VectorBehaviorTests.RelationalAndSelect),
                ("half wrapper preserves binary16 values and maths helpers", VectorBehaviorTests.Half),
                ...
                ("canonical managed Maths forwards scalar operations", VectorBehaviorTests.CanonicalMathsFacade),
