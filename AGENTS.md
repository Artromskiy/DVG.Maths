...
- [docs/README.md](docs/README.md) — stable API and matrix convention.
...
- [docs/CPU_GPU_CONFORMANCE.md](docs/CPU_GPU_CONFORMANCE.md) — authoritative
  CPU/Shader/Vulkan differential-conformance protocol and ownership split.
