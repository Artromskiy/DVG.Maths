...
namespace DVG
{
    ...
    public static partial class glsh
    {
        ...
        /// </summary>
        public static float4 SmoothStep(float4 edge0, float4 edge1, float4 x) => float4.SmoothStep(edge0, edge1, x);
        ...
        /// Compares two values
        /// </summary>
        public static int CompareTo(float4 v, float4 other) => v.CompareTo(other);
