...
namespace Delta
{
    /// <summary>A column-major 4x3 matrix represented by 4 float3 columns.</summary>
    [Serializable]
    ...
    public partial struct float4x3 : IEquatable<float4x3>
    {
        ...
        public static readonly float4x3 zero = new float4x3(float3.zero, float3.zero, float3.zero, float3.zero);
        ...
        public float4x3(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34)
        {
            ...
            _padding2 = 0f;
            c3 = new float3(m14, m24, m34);
            _padding3 = 0f;
        }

        /// <summary>Creates a float4x3 from a float2x2 using GLSL matrix conversion rules.</summary>
        public float4x3(float2x2 value)
        {
        ...
        /// <summary>Creates a float4x3 from a float2x3 using GLSL matrix conversion rules.</summary>
        public float4x3(float2x3 value)
        {
        ...
        /// <summary>Creates a float4x3 from a float2x4 using GLSL matrix conversion rules.</summary>
        public float4x3(float2x4 value)
        {
            c0 = new float3(value.c0.x, value.c0.y, value.c0.z);
            _padding0 = 0f;
            c1 = new float3(value.c1.x, value.c1.y, value.c1.z);
        ...
        /// <summary>Creates a float4x3 from a float3x2 using GLSL matrix conversion rules.</summary>
        public float4x3(float3x2 value)
        {
            c0 = new float3(value.c0.x, value.c0.y, 0f);
            _padding0 = 0f;
            c1 = new float3(value.c1.x, value.c1.y, 0f);
        ...
        /// <summary>Creates a float4x3 from a float3x3 using GLSL matrix conversion rules.</summary>
        public float4x3(float3x3 value)
        {
            c0 = new float3(value.c0.x, value.c0.y, value.c0.z);
            _padding0 = 0f;
            c1 = new float3(value.c1.x, value.c1.y, value.c1.z);
        ...
        /// <summary>Creates a float4x3 from a float3x4 using GLSL matrix conversion rules.</summary>
        public float4x3(float3x4 value)
        {
            c0 = new float3(value.c0.x, value.c0.y, value.c0.z);
            _padding0 = 0f;
            c1 = new float3(value.c1.x, value.c1.y, value.c1.z);
        ...
        /// <summary>Creates a float4x3 from a float4x2 using GLSL matrix conversion rules.</summary>
        public float4x3(float4x2 value)
        {
            c0 = new float3(value.c0.x, value.c0.y, 0f);
            _padding0 = 0f;
            c1 = new float3(value.c1.x, value.c1.y, 0f);
            ...
            c2 = new float3(value.c2.x, value.c2.y, 1f);
            _padding2 = 0f;
            c3 = new float3(value.c3.x, value.c3.y, 0f);
            _padding3 = 0f;
        }

        /// <summary>Creates a float4x3 from a float4x3 using GLSL matrix conversion rules.</summary>
        public float4x3(float4x3 value)
        {
            c0 = new float3(value.c0.x, value.c0.y, value.c0.z);
            _padding0 = 0f;
            c1 = new float3(value.c1.x, value.c1.y, value.c1.z);
            ...
            c2 = new float3(value.c2.x, value.c2.y, value.c2.z);
            _padding2 = 0f;
            c3 = new float3(value.c3.x, value.c3.y, value.c3.z);
            _padding3 = 0f;
        }

        /// <summary>Creates a float4x3 from a float4x4 using GLSL matrix conversion rules.</summary>
        public float4x3(float4x4 value)
        {
            c0 = new float3(value.c0.x, value.c0.y, value.c0.z);
            _padding0 = 0f;
            c1 = new float3(value.c1.x, value.c1.y, value.c1.z);
        ...
        {
            return index switch { 0 => new float4(c0.x, c1.x, c2.x, c3.x), 1 => new float4(c0.y, c1.y, c2.y, c3.y), 2 => new float4(c0.z, c1.z, c2.z, c3.z), _ => throw new ArgumentOutOfRangeException(nameof(index)) };
        }
