...
namespace Delta
{
    ...
    public partial struct fix4 : IEquatable<fix4>, IComparable<fix4>
    {
        ...
        public static fix4 Parse(string value)
        {
            ...
            return new(fix.Parse(values[0].Trim(), System.Globalization.CultureInfo.InvariantCulture), fix.Parse(values[1].Trim(), System.Globalization.CultureInfo.InvariantCulture), fix.Parse(values[2].Trim(), System.Globalization.CultureInfo.InvariantCulture), fix.Parse(values[3].Trim(), System.Globalization.CultureInfo.InvariantCulture));
        }
        ...
        public static fix4 Parse(string value, IFormatProvider format)
        {
            ...
            if (values.Length != 4)
                throw new FormatException("Expected 4 vector components.");
            return new(fix.Parse(values[0].Trim(), format), fix.Parse(values[1].Trim(), format), fix.Parse(values[2].Trim(), format), fix.Parse(values[3].Trim(), format));
        }
    }
}
