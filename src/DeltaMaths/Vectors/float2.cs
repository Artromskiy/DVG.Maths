...
namespace Delta
{
    ...
    public partial struct float2 : IEquatable<float2>, IComparable<float2>
    {
        ...
        public static float2 Parse(string value)
        {
            ...
            return new(float.Parse(values[0].Trim(), System.Globalization.CultureInfo.InvariantCulture), float.Parse(values[1].Trim(), System.Globalization.CultureInfo.InvariantCulture));
        }
        ...
        public static float2 Parse(string value, IFormatProvider format)
        {
            ...
            if (values.Length != 2)
                throw new FormatException("Expected 2 vector components.");
            return new(float.Parse(values[0].Trim(), format), float.Parse(values[1].Trim(), format));
        }
    }
}
